...
make -f Makefile -f $TRY_EDA_OVERRIDES_FILE try-eda NO_KIND=yes NO_LB=yes KPT_SETTERS_FILE=$TRY_EDA_KPT_SETTERS_FILE EXT_HTTPS_PORT=443 EXT_DOMAIN_NAME="$CODESPACE_NAME-9443.$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN"